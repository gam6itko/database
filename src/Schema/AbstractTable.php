 ...
 * @method AbstractColumn integer($column, array $options = [])
 * @method AbstractColumn tinyInteger($column, array $options = [])
 * @method AbstractColumn smallInteger($column, array $options = [])
 * @method AbstractColumn bigInteger($column, array $options = [])
